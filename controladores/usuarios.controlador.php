            ...
            preg_match('/^[a-zA-Z0-9]+$/',$_POST["ingPassword"])
                ...
                if(is_array($respuesta) && $respuesta["usuario"] == $_POST["ingUsuario"] && $respuesta["password"] == $encriptar){
                    ...
                    if($respuesta["estado"] == 1){
                        ...
                        //Registrar fecha y hora para saber ultimo login
			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nuevoNombre"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["nuevoPassword"])){
                ...
                if(isset($_FILES["nuevaFoto"]["tmp_name"]) && $_FILES["nuevaFoto"]["tmp_name"]!=""){
                    ...
                    // Creamos directorio donde se guarda la foto del usuario 
                    $directorio = "vistas/img/usuarios/".$_POST["nuevoUsuario"];
                    mkdir($directorio,0755);
                    // De acuerdo al tipo de imagen, aplicamos funciones por defecto de php
            ...
            if($_GET["idUsuario"]!= $_SESSION["id"]){
                ...
                echo "<script>
                    ...
                    Swal.fire({
                        ...
                        icon: 'error',
                        title: 'No puedes eliminar el usuario que estás usando actualmente!',
                        showConfirmButton: true,
                        confirmButtonText: 'Cerrar'
