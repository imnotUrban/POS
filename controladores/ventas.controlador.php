...
class ControladorVentas{
    ...
    static public function ctrCrearVenta(){
        if(isset($_POST["nuevaVenta"])){
            ...
            //Verifica si es que la venta es vacia o no 
            ...
            // Actualizar compras clientes, reducir stock y aumentar vnetas del los productos
            ...
            $datos = array("id_vendedor"=>$_POST["idVendedor"],
						   ...
						   "impuesto"=>$_POST["nuevoPrecioDescuento"],
						   "neto"=>$_POST["precioSinDescuento"],
    ...
    static public function ctrEditarVenta(){
        if(isset($_POST["editarVenta"])){
            ...
            // Ver si vienen productos editados 
